...
6. CRITICAL RULES:
- Do NOT follow a fixed questionnaire order.
- Analyze the entire conversationHistory before choosing the next question.
- Extract every clinically relevant fact already provided by the patient.
- Do NOT ask again for information that is already clearly answered.
- Choose the ONE missing piece of information that has the highest clinical value for the current complaint.
- Prioritize when relevant: emergency/red flags, chief complaint clarification, onset/timing, severity, location/radiation, associated symptoms, aggravating/relieving factors, relevant past history, medications/allergies, and risk factors.
- If the patient gives multiple symptoms, identify the main complaint and ask the next question that best separates important possibilities.
- If the patient gives a negative finding such as "no fever", store it as an explicit negative finding and do not ask the same question again unless clarification is needed.
- If the patient's answer is ambiguous, contradictory, incomplete, or unclear, ask a short clarification question instead of assuming.
- If a body-map location is available, use that exact location in the question when clinically relevant.
- Ask ONLY ONE question at a time.
- Never diagnose or say that a disease is confirmed.
- The output should support differential assessment and clinician review.
- When enough clinically useful information has been collected, set isInterviewComplete=true rather than continuing unnecessary questions.
...
Return strictly JSON with schema:
{
  ...
  "aiDisclaimer": "AI-generated draft â€” Physician verification required. Not an autonomous medical diagnosis."
}`;
...
function generateHeuristicQuestion(params: any) {
  ...
  if (painLocations && painLocations.length > 0 && historyLength >= 1 && historyLength <= 3) {
    ...
    const qText =
      language === "Hindi"
        ? `à¤†à¤ªà¤•à¥‡ ${locName} à¤®à¥‡à¤‚ à¤¯à¤¹ à¤¦à¤°à¥à¤¦ à¤•à¥ˆà¤¸à¤¾ à¤®à¤¹à¤¸à¥‚à¤¸ à¤¹à¥‹à¤¤à¤¾ à¤¹à¥ˆ (à¤¤à¥€à¤–à¤¾, à¤¸à¥à¤ˆ à¤œà¥ˆà¤¸à¤¾, à¤œà¤²à¤¨, à¤¯à¤¾ à¤­à¤¾à¤°à¥€ à¤¦à¤¬à¤¾à¤µ)?`
        : language === "Tamil"
        ? `à®‰à®™à¯à®•à®³à¯ ${locName} à®ªà®•à¯à®¤à®¿à®¯à®¿à®²à¯ à®‡à®¨à¯à®¤ à®µà®²à®¿ à®Žà®ªà¯à®ªà®Ÿà®¿ à®‡à®°à¯à®•à¯à®•à®¿à®±à®¤à¯ (à®•à¯à®¤à¯à®¤à¯à®µà®¤à¯ à®ªà¯‹à®©à¯à®±à¯, à®•à®©à®®à®¾à®•, à®…à®²à¯à®²à®¤à¯ à®Žà®°à®¿à®•à®¿à®±à®¤à®¾)?`
  ...
  const questionsMap: Record<string, Array<{ en: string; q: string; cat: string; opts: string[] }>> = {
    ...
    Hindi: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à¤†à¤œ à¤†à¤ªà¤•à¥‹ à¤•à¥à¤¯à¤¾ à¤®à¥à¤–à¥à¤¯ à¤¸à¥à¤µà¤¾à¤¸à¥à¤¥à¥à¤¯ à¤¸à¤®à¤¸à¥à¤¯à¤¾ à¤¯à¤¾ à¤¤à¤•à¤²à¥€à¤« à¤¹à¥ˆ?",
        cat: "Chief Complaint",
        opts: ["à¤¸à¥€à¤¨à¥‡ à¤®à¥‡à¤‚ à¤¦à¤°à¥à¤¦ / à¤­à¤¾à¤°à¥€à¤ªà¤¨", "à¤¬à¥à¤–à¤¾à¤° à¤”à¤° à¤ à¤‚à¤¡ à¤²à¤—à¤¨à¤¾", "à¤–à¤¾à¤‚à¤¸à¥€ à¤”à¤° à¤¸à¤¾à¤‚à¤¸ à¤«à¥‚à¤²à¤¨à¤¾", "à¤ªà¥‡à¤Ÿ à¤¦à¤°à¥à¤¦ à¤¯à¤¾ à¤‰à¤²à¥à¤Ÿà¥€", "à¤œà¥‹à¤¡à¤¼à¥‹à¤‚ à¤¯à¤¾ à¤•à¤®à¤° à¤•à¤¾ à¤¦à¤°à¥à¤¦", "à¤¸à¤¾à¤®à¤¾à¤¨à¥à¤¯ à¤•à¤®à¤œà¥‹à¤°à¥€"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à¤¯à¤¹ à¤¤à¤•à¤²à¥€à¤« à¤•à¤¬ à¤¶à¥à¤°à¥‚ à¤¹à¥à¤ˆ à¤”à¤° à¤•à¤¿à¤¤à¤¨à¥‡ à¤¸à¤®à¤¯ à¤¸à¥‡ à¤¹à¥‹ à¤°à¤¹à¥€ à¤¹à¥ˆ?",
        cat: "HPI - Onset & Duration",
        opts: ["à¤†à¤œ à¤…à¤šà¤¾à¤¨à¤• à¤¶à¥à¤°à¥‚ à¤¹à¥à¤ˆ", "à¤ªà¤¿à¤›à¤²à¥‡ 2-3 à¤¦à¤¿à¤¨à¥‹à¤‚ à¤¸à¥‡", "à¤²à¤—à¤­à¤— 1 à¤¹à¤«à¥à¤¤à¥‡ à¤¸à¥‡", "à¤à¤• à¤®à¤¹à¥€à¤¨à¥‡ à¤¸à¥‡ à¤œà¥à¤¯à¤¾à¤¦à¤¾", "à¤°à¥à¤•-à¤°à¥à¤• à¤•à¤° à¤†à¤¤à¥€ à¤¹à¥ˆ"],
      },
      {
        en: "How would you describe the sensation or character of this issue?",
        q: "à¤‡à¤¸ à¤¦à¤°à¥à¤¦ à¤¯à¤¾ à¤¤à¤•à¤²à¥€à¤« à¤•à¤¾ à¤…à¤¹à¤¸à¤¾à¤¸ à¤•à¥ˆà¤¸à¤¾ à¤¹à¥ˆ?",
        cat: "HPI - Character",
        opts: ["à¤­à¤¾à¤°à¥€ à¤¦à¤¬à¤¾à¤µ à¤¯à¤¾ à¤œà¤•à¤¡à¤¼à¤¨", "à¤¤à¥‡à¤œ à¤šà¥à¤­à¤¨ à¤œà¥ˆà¤¸à¤¾ à¤¦à¤°à¥à¤¦", "à¤¹à¤²à¥à¤•à¤¾ à¤®à¥€à¤ à¤¾ à¤¦à¤°à¥à¤¦", "à¤œà¤²à¤¨ à¤œà¥ˆà¤¸à¤¾ à¤…à¤¹à¤¸à¤¾à¤¸", "à¤§à¤¡à¤¼à¤•à¤¨ à¤œà¥ˆà¤¸à¤¾ à¤¦à¤°à¥à¤¦"],
      },
      {
        en: "Does the discomfort spread or radiate to any other part of your body?",
        q: "à¤•à¥à¤¯à¤¾ à¤¯à¤¹ à¤¦à¤°à¥à¤¦ à¤¶à¤°à¥€à¤° à¤•à¥‡ à¤•à¤¿à¤¸à¥€ à¤…à¤¨à¥à¤¯ à¤¹à¤¿à¤¸à¥à¤¸à¥‡ à¤œà¥ˆà¤¸à¥‡ à¤•à¤‚à¤§à¥‡, à¤¹à¤¾à¤¥ à¤¯à¤¾ à¤œà¤¬à¤¡à¤¼à¥‡ à¤®à¥‡à¤‚ à¤«à¥ˆà¤²à¤¤à¤¾ à¤¹à¥ˆ?",
        cat: "HPI - Radiation",
        opts: ["à¤¬à¤¾à¤à¤‚ à¤¹à¤¾à¤¥ / à¤•à¤‚à¤§à¥‡ à¤®à¥‡à¤‚ à¤«à¥ˆà¤²à¤¤à¤¾ à¤¹à¥ˆ", "à¤—à¤°à¥à¤¦à¤¨ à¤¯à¤¾ à¤œà¤¬à¤¡à¤¼à¥‡ à¤®à¥‡à¤‚ à¤œà¤¾à¤¤à¤¾ à¤¹à¥ˆ", "à¤ªà¥€à¤  à¤•à¥€ à¤¤à¤°à¤« à¤«à¥ˆà¤²à¤¤à¤¾ à¤¹à¥ˆ", "à¤à¤• à¤¹à¥€ à¤œà¤—à¤¹ à¤°à¤¹à¤¤à¤¾ à¤¹à¥ˆ", "à¤•à¤¹à¥€à¤‚ à¤¨à¤¹à¥€à¤‚ à¤«à¥ˆà¤²à¤¤à¤¾"],
      },
      {
        en: "On a scale from 1 (mild) to 10 (most severe), how intense is it right now?",
        q: "1 (à¤¹à¤²à¥à¤•à¤¾) à¤¸à¥‡ 10 (à¤…à¤¤à¥à¤¯à¤§à¤¿à¤• à¤¤à¥‡à¤œ) à¤•à¥‡ à¤ªà¥ˆà¤®à¤¾à¤¨à¥‡ à¤ªà¤°, à¤…à¤­à¥€ à¤¯à¤¹ à¤¦à¤°à¥à¤¦ à¤•à¤¿à¤¤à¤¨à¤¾ à¤¤à¥‡à¤œ à¤¹à¥ˆ?",
        cat: "HPI - Severity",
        opts: ["à¤¹à¤²à¥à¤•à¤¾ (1 - 3)", "à¤®à¤§à¥à¤¯à¤® (4 - 6)", "à¤¤à¥‡à¤œ à¤¦à¤°à¥à¤¦ (7 - 8)", "à¤¬à¤¹à¥à¤¤ à¤—à¤‚à¤­à¥€à¤° (9 - 10)"],
      },
      {
        en: "Are you experiencing any associated symptoms like sweating, breathlessness, nausea, or dizziness?",
        q: "à¤•à¥à¤¯à¤¾ à¤†à¤ªà¤•à¥‹ à¤¸à¤¾à¤¥ à¤®à¥‡à¤‚ à¤ªà¤¸à¥€à¤¨à¤¾ à¤†à¤¨à¤¾, à¤¸à¤¾à¤‚à¤¸ à¤«à¥‚à¤²à¤¨à¤¾, à¤œà¥€ à¤˜à¤¬à¤°à¤¾à¤¨à¤¾ à¤¯à¤¾ à¤šà¤•à¥à¤•à¤° à¤†à¤¨à¤¾ à¤®à¤¹à¤¸à¥‚à¤¸ à¤¹à¥‹ à¤°à¤¹à¤¾ à¤¹à¥ˆ?",
        cat: "HPI - Associated Symptoms",
        opts: ["à¤…à¤¤à¥à¤¯à¤§à¤¿à¤• à¤ªà¤¸à¥€à¤¨à¤¾ à¤† à¤°à¤¹à¤¾ à¤¹à¥ˆ", "à¤šà¤²à¤¨à¥‡ à¤ªà¤° à¤¸à¤¾à¤‚à¤¸ à¤«à¥‚à¤² à¤°à¤¹à¥€ à¤¹à¥ˆ", "à¤œà¥€ à¤®à¤¿à¤šà¤²à¤¾à¤¨à¤¾ à¤¯à¤¾ à¤‰à¤²à¥à¤Ÿà¥€", "à¤šà¤•à¥à¤•à¤° à¤†à¤¨à¤¾", "à¤‡à¤¨à¤®à¥‡à¤‚ à¤¸à¥‡ à¤•à¥‹à¤ˆ à¤¨à¤¹à¥€à¤‚"],
      },
      {
        en: "Do you have any known medical conditions like Diabetes, High Blood Pressure, or Heart Disease?",
        q: "à¤•à¥à¤¯à¤¾ à¤†à¤ªà¤•à¥‹ à¤ªà¤¹à¤²à¥‡ à¤¸à¥‡ à¤¡à¤¾à¤¯à¤¬à¤¿à¤Ÿà¥€à¤œ (à¤¶à¥à¤—à¤°), à¤¹à¤¾à¤ˆ à¤¬à¥€à¤ªà¥€ à¤¯à¤¾ à¤¦à¤¿à¤² à¤•à¥€ à¤•à¥‹à¤ˆ à¤¬à¥€à¤®à¤¾à¤°à¥€ à¤¹à¥ˆ?",
        cat: "Past Medical History",
        opts: ["à¤¡à¤¾à¤¯à¤¬à¤¿à¤Ÿà¥€à¤œ (à¤¶à¥à¤—à¤°)", "à¤¹à¤¾à¤ˆ à¤¬à¥à¤²à¤¡ à¤ªà¥à¤°à¥‡à¤¶à¤° (à¤¬à¥€à¤ªà¥€)", "à¤¹à¥ƒà¤¦à¤¯ à¤°à¥‹à¤— / à¤¸à¥à¤Ÿà¥‡à¤‚à¤Ÿ", "à¤…à¤¸à¥à¤¥à¤®à¤¾ à¤¯à¤¾ à¤¥à¤¾à¤¯à¤°à¥‰à¤‡à¤¡", "à¤•à¥‹à¤ˆ à¤œà¥à¤žà¤¾à¤¤ à¤¬à¥€à¤®à¤¾à¤°à¥€ à¤¨à¤¹à¥€à¤‚"],
      },
      {
        en: "What daily medicines or tablets are you currently taking?",
        q: "à¤†à¤ª à¤°à¥‹à¤œà¤¾à¤¨à¤¾ à¤•à¥Œà¤¨ à¤¸à¥€ à¤¦à¤µà¤¾à¤‡à¤¯à¤¾à¤‚ à¤¯à¤¾ à¤—à¥‹à¤²à¤¿à¤¯à¤¾à¤‚ à¤²à¥‡ à¤°à¤¹à¥‡ à¤¹à¥ˆà¤‚?",
        cat: "Medication History",
        opts: ["à¤¬à¥€à¤ªà¥€ à¤•à¥€ à¤—à¥‹à¤²à¥€", "à¤¶à¥à¤—à¤° à¤•à¥€ à¤¦à¤µà¤¾", "à¤–à¥‚à¤¨ à¤ªà¤¤à¤²à¤¾ à¤•à¤°à¤¨à¥‡ à¤•à¥€ à¤¦à¤µà¤¾ (à¤à¤¸à¥à¤ªà¤¿à¤°à¤¿à¤¨)", "à¤†à¤¯à¥à¤°à¥à¤µà¥‡à¤¦à¤¿à¤• à¤¯à¤¾ à¤¦à¥‡à¤¸à¥€ à¤¦à¤µà¤¾à¤à¤‚", "à¤«à¤¿à¤²à¤¹à¤¾à¤² à¤•à¥‹à¤ˆ à¤¦à¤µà¤¾ à¤¨à¤¹à¥€à¤‚"],
      },
      {
        en: "Do you have any known allergies to medicines, foods, or substances?",
        q: "à¤•à¥à¤¯à¤¾ à¤†à¤ªà¤•à¥‹ à¤•à¤¿à¤¸à¥€ à¤¦à¤µà¤¾ à¤¯à¤¾ à¤–à¤¾à¤¨à¥‡ à¤¸à¥‡ à¤•à¥‹à¤ˆ à¤à¤²à¤°à¥à¤œà¥€ à¤¹à¥ˆ?",
        cat: "Allergy History",
        opts: ["à¤ªà¥‡à¤¨à¤¿à¤¸à¤¿à¤²à¤¿à¤¨ à¤¸à¥‡ à¤à¤²à¤°à¥à¤œà¥€", "à¤¸à¤²à¥à¤«à¤¾ à¤¦à¤µà¤¾à¤“à¤‚ à¤¸à¥‡ à¤à¤²à¤°à¥à¤œà¥€", "à¤§à¥‚à¤² à¤¯à¤¾ à¤®à¥Œà¤¸à¤® à¤¸à¥‡ à¤à¤²à¤°à¥à¤œà¥€", "à¤–à¤¾à¤¦à¥à¤¯ à¤ªà¤¦à¤¾à¤°à¥à¤¥ à¤¸à¥‡ à¤à¤²à¤°à¥à¤œà¥€", "à¤•à¥‹à¤ˆ à¤à¤²à¤°à¥à¤œà¥€ à¤¨à¤¹à¥€à¤‚ à¤¹à¥ˆ"],
      },
    ],
    Tamil: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à®‡à®©à¯à®±à¯ à®‰à®™à¯à®•à®³à¯à®•à¯à®•à¯ à®Žà®©à¯à®© à®®à¯à®•à¯à®•à®¿à®¯ à®‰à®Ÿà®²à¯à®¨à®²à®ªà¯ à®ªà®¿à®°à®šà¯à®šà®¿à®©à¯ˆ à®‰à®³à¯à®³à®¤à¯?",
        cat: "Chief Complaint",
        opts: ["à®¨à¯†à®žà¯à®šà¯ à®µà®²à®¿ / à®ªà®¾à®°à®®à¯", "à®•à®¾à®¯à¯à®šà¯à®šà®²à¯ à®®à®±à¯à®±à¯à®®à¯ à®¨à®Ÿà¯à®•à¯à®•à®®à¯", "à®‡à®°à¯à®®à®²à¯ & à®®à¯‚à®šà¯à®šà¯à®¤à¯à®¤à®¿à®£à®±à®²à¯", "à®µà®¯à®¿à®±à¯à®±à¯ à®µà®²à®¿ / à®•à¯à®®à®Ÿà¯à®Ÿà®²à¯", "à®®à¯‚à®Ÿà¯à®Ÿà¯ à®…à®²à¯à®²à®¤à¯ à®®à¯à®¤à¯à®•à¯ à®µà®²à®¿", "à®ªà¯Šà®¤à¯à®µà®¾à®© à®šà¯‹à®°à¯à®µà¯"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à®‡à®¨à¯à®¤ à®µà®²à®¿ à®…à®²à¯à®²à®¤à¯ à®‰à®ªà®¾à®¤à¯ˆ à®Žà®ªà¯à®ªà¯‹à®¤à¯ à®¤à¯Šà®Ÿà®™à¯à®•à®¿à®¯à®¤à¯?",
        cat: "HPI - Onset & Duration",
        opts: ["à®‡à®©à¯à®±à¯ à®¤à®¿à®Ÿà¯€à®°à¯†à®© à®¤à¯Šà®Ÿà®™à¯à®•à®¿à®¯à®¤à¯", "à®•à®Ÿà®¨à¯à®¤ 2-3 à®¨à®¾à®Ÿà¯à®•à®³à®¾à®•", "à®šà¯à®®à®¾à®°à¯ 1 à®µà®¾à®°à®®à®¾à®•", "à®’à®°à¯ à®®à®¾à®¤à®¤à¯à®¤à®¿à®±à¯à®•à¯à®®à¯ à®®à¯‡à®²à®¾à®•", "à®µà®¿à®Ÿà¯à®Ÿà¯ à®µà®¿à®Ÿà¯à®Ÿà¯ à®µà®°à¯à®•à®¿à®±à®¤à¯"],
      },
      {
        en: "How would you describe the sensation or character of this issue?",
        q: "à®‡à®¨à¯à®¤ à®µà®²à®¿à®¯à®¿à®©à¯ à®¤à®©à¯à®®à¯ˆ à®Žà®ªà¯à®ªà®Ÿà®¿ à®‡à®°à¯à®•à¯à®•à®¿à®±à®¤à¯?",
        cat: "HPI - Character",
        opts: ["à®…à®´à¯à®¤à¯à®¤à¯à®µà®¤à¯ à®ªà¯‹à®©à¯à®± à®ªà®¾à®°à®®à¯", "à®•à¯à®¤à¯à®¤à¯à®µà®¤à¯ à®ªà¯‹à®©à¯à®± à®•à¯‚à®°à¯à®®à¯ˆà®¯à®¾à®© à®µà®²à®¿", "à®²à¯‡à®šà®¾à®© à®¤à¯Šà®Ÿà®°à¯ à®µà®²à®¿", "à®Žà®°à®¿à®šà¯à®šà®²à¯ à®‰à®£à®°à¯à®µà¯", "à®¤à¯à®Ÿà®¿à®•à¯à®•à¯à®®à¯ à®µà®²à®¿"],
      },
      {
        en: "Does the discomfort spread or radiate to any other part of your body?",
        q: "à®µà®²à®¿ à®•à¯ˆ, à®•à®´à¯à®¤à¯à®¤à¯ à®…à®²à¯à®²à®¤à¯ à®®à¯à®¤à¯à®•à¯à®•à¯à®•à¯ à®ªà®°à®µà¯à®•à®¿à®±à®¤à®¾?",
        cat: "HPI - Radiation",
        opts: ["à®‡à®Ÿà®¤à¯ à®•à¯ˆ / à®¤à¯‹à®³à¯à®•à¯à®•à¯ à®ªà®°à®µà¯à®•à®¿à®±à®¤à¯", "à®•à®´à¯à®¤à¯à®¤à¯ à®…à®²à¯à®²à®¤à¯ à®¤à®¾à®Ÿà¯ˆà®•à¯à®•à¯ à®šà¯†à®²à¯à®•à®¿à®±à®¤à¯", "à®®à¯à®¤à¯à®•à¯à®•à¯à®•à¯ à®ªà®°à®µà¯à®•à®¿à®±à®¤à¯", "à®’à®°à¯‡ à®‡à®Ÿà®¤à¯à®¤à®¿à®²à¯ à®‰à®³à¯à®³à®¤à¯", "à®Žà®™à¯à®•à¯à®®à¯ à®ªà®°à®µà®µà®¿à®²à¯à®²à¯ˆ"],
      },
      {
        en: "On a scale from 1 (mild) to 10 (most severe), how intense is it right now?",
        q: "1 à®®à¯à®¤à®²à¯ 10 à®µà®°à¯ˆ à®‰à®³à¯à®³ à®…à®³à®µà®¿à®²à¯ à®µà®²à®¿à®¯à®¿à®©à¯ à®…à®³à®µà¯ à®Žà®µà¯à®µà®³à®µà¯?",
        cat: "HPI - Severity",
        opts: ["à®®à®¿à®¤à®®à®¾à®© (1 - 3)", "à®¨à®Ÿà¯à®¤à¯à®¤à®° (4 - 6)", "à®•à®Ÿà¯à®®à¯ˆà®¯à®¾à®© (7 - 8)", "à®®à®¿à®•à®¤à¯ à®¤à¯€à®µà®¿à®°à®®à®¾à®© (9 - 10)"],
      },
      {
        en: "Are you experiencing any associated symptoms like sweating, breathlessness, nausea, or dizziness?",
        q: "à®µà®¿à®¯à®°à¯à®µà¯ˆ, à®®à¯‚à®šà¯à®šà¯à®¤à¯à®¤à®¿à®£à®±à®²à¯, à®µà®¾à®¨à¯à®¤à®¿ à®…à®²à¯à®²à®¤à¯ à®®à®¯à®•à¯à®•à®®à¯ à®ªà¯‹à®©à¯à®± à®…à®±à®¿à®•à¯à®±à®¿à®•à®³à¯ à®‰à®³à¯à®³à®¤à®¾?",
        cat: "HPI - Associated Symptoms",
        opts: ["à®…à®¤à®¿à®• à®µà®¿à®¯à®°à¯à®µà¯ˆ", "à®¨à®Ÿà®•à¯à®•à¯à®®à¯à®ªà¯‹à®¤à¯ à®®à¯‚à®šà¯à®šà¯à®¤à¯à®¤à®¿à®£à®±à®²à¯", "à®•à¯à®®à®Ÿà¯à®Ÿà®²à¯ à®…à®²à¯à®²à®¤à¯ à®µà®¾à®¨à¯à®¤à®¿", "à®¤à®²à¯ˆà®šà¯à®šà¯à®±à¯à®±à®²à¯", "à®Žà®¤à¯à®µà¯à®®à¯ à®‡à®²à¯à®²à¯ˆ"],
      },
      {
        en: "Do you have any known medical conditions like Diabetes, High Blood Pressure, or Heart Disease?",
        q: "à®‰à®™à¯à®•à®³à¯à®•à¯à®•à¯ à®šà®°à¯à®•à¯à®•à®°à¯ˆ à®¨à¯‹à®¯à¯, à®‡à®°à®¤à¯à®¤ à®…à®´à¯à®¤à¯à®¤à®®à¯ (BP) à®…à®²à¯à®²à®¤à¯ à®‡à®¤à®¯ à®¨à¯‹à®¯à¯ à®‰à®³à¯à®³à®¤à®¾?",
        cat: "Past Medical History",
        opts: ["à®šà®°à¯à®•à¯à®•à®°à¯ˆ à®¨à¯‹à®¯à¯ (Diabetes)", "à®‡à®°à®¤à¯à®¤ à®…à®´à¯à®¤à¯à®¤à®®à¯ (BP)", "à®‡à®¤à®¯ à®¨à¯‹à®¯à¯ / à®¸à¯à®Ÿà¯†à®©à¯à®Ÿà¯", "à®†à®¸à¯à®¤à¯à®®à®¾ / à®¤à¯ˆà®°à®¾à®¯à¯à®Ÿà¯", "à®®à¯à®¨à¯à®¤à¯ˆà®¯ à®¨à¯‹à®¯à¯à®•à®³à¯ à®à®¤à¯à®®à®¿à®²à¯à®²à¯ˆ"],
      },
    ],
    Telugu: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à°ˆ à°°à±‹à°œà± à°®à±€à°•à± à°ªà±à°°à°§à°¾à°¨à°‚à°—à°¾ à°‰à°¨à±à°¨ à°†à°°à±‹à°—à±à°¯ à°¸à°®à°¸à±à°¯ à°²à±‡à°¦à°¾ à°¬à°¾à°§ à°à°®à°¿à°Ÿà°¿?",
        cat: "Chief Complaint",
        opts: ["à°›à°¾à°¤à±€à°²à±‹ à°¨à±Šà°ªà±à°ªà°¿ à°²à±‡à°¦à°¾ à°¬à°°à±à°µà±", "à°¤à±€à°µà±à°°à°®à±ˆà°¨ à°œà±à°µà°°à°‚ à°®à°°à°¿à°¯à± à°µà°£à±à°•à±", "à°¦à°—à±à°—à± à°®à°°à°¿à°¯à± à°†à°¯à°¾à°¸à°‚", "à°•à°¡à±à°ªà± à°¨à±Šà°ªà±à°ªà°¿ à°²à±‡à°¦à°¾ à°µà°¿à°•à°¾à°°à°‚", "à°•à±€à°³à±à°³à± à°²à±‡à°¦à°¾ à°¨à°¡à±à°®à± à°¨à±Šà°ªà±à°ªà°¿", "à°¨à±€à°°à°¸à°‚"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à°ˆ à°¸à°®à°¸à±à°¯ à°Žà°ªà±à°ªà±à°¡à± à°ªà±à°°à°¾à°°à°‚à°­à°®à±ˆà°‚à°¦à°¿ à°®à°°à°¿à°¯à± à°Žà°‚à°¤à°•à°¾à°²à°‚à°—à°¾ à°‰à°‚à°¦à°¿?",
        cat: "HPI - Onset & Duration",
        opts: ["à°ˆ à°°à±‹à°œà± à°…à°•à°¸à±à°®à°¾à°¤à±à°¤à±à°—à°¾ à°ªà±à°°à°¾à°°à°‚à°­à°®à±ˆà°‚à°¦à°¿", "à°—à°¤ 2-3 à°°à±‹à°œà±à°²à±à°—à°¾", "à°¸à±à°®à°¾à°°à± 1 à°µà°¾à°°à°‚ à°¨à±à°‚à°¡à°¿", "à°¨à±†à°² à°•à°‚à°Ÿà±‡ à°Žà°•à±à°•à±à°µ à°°à±‹à°œà±à°²à±à°—à°¾", "à°…à°ªà±à°ªà±à°¡à°ªà±à°ªà±à°¡à± à°µà°¸à±à°¤à±‹à°‚à°¦à°¿"],
      },
      {
        en: "How would you describe the sensation or character of this issue?",
        q: "à°ˆ à°¨à±Šà°ªà±à°ªà°¿ à°²à±‡à°¦à°¾ à°…à°¸à±Œà°•à°°à±à°¯à°‚ à°Žà°²à°¾à°‚à°Ÿà°¿ à°…à°¨à±à°­à±‚à°¤à°¿à°¨à°¿ à°•à°²à°¿à°—à°¿à°¸à±à°¤à±‹à°‚à°¦à°¿?",
        cat: "HPI - Character",
        opts: ["à°­à°¾à°°à±€ à°’à°¤à±à°¤à°¿à°¡à°¿ à°²à±‡à°¦à°¾ à°¬à°¿à°—à±à°¤à±à°—à°¾ à°‰à°‚à°¡à°Ÿà°‚", "à°¸à±‚à°¦à°¿à°¤à±‹ à°—à±à°šà±à°šà°¿à°¨à°Ÿà±à°²à± à°‰à°‚à°¡à±‡ à°¨à±Šà°ªà±à°ªà°¿", "à°®à°‚à°¦à°•à±Šà°¡à°¿à°—à°¾ à°‰à°‚à°¡à±‡ à°¨à±Šà°ªà±à°ªà°¿", "à°®à°‚à°Ÿà°—à°¾ à°‰à°‚à°¡à°Ÿà°‚", "à°¦à°¡à°¦à°¡à°²à°¾à°¡à±‡ à°¨à±Šà°ªà±à°ªà°¿"],
      },
      {
        en: "Does the discomfort spread or radiate to any other part of your body?",
        q: "à°ˆ à°¨à±Šà°ªà±à°ªà°¿ à°Žà°¡à°® à°šà±‡à°¯à°¿, à°¦à°µà°¡ à°²à±‡à°¦à°¾ à°µà±€à°ªà± à°µà±ˆà°ªà± à°µà±à°¯à°¾à°ªà°¿à°¸à±à°¤à±‹à°‚à°¦à°¾?",
        cat: "HPI - Radiation",
        opts: ["à°Žà°¡à°® à°šà±‡à°¯à°¿ / à°­à±à°œà°¾à°¨à°¿à°•à°¿ à°µà±à°¯à°¾à°ªà°¿à°¸à±à°¤à±‹à°‚à°¦à°¿", "à°®à±†à°¡ à°²à±‡à°¦à°¾ à°¦à°µà°¡ à°µà±ˆà°ªà± à°µà±†à°³à±à°¤à±‹à°‚à°¦à°¿", "à°µà±€à°ªà± à°µà±ˆà°ªà± à°µà±à°¯à°¾à°ªà°¿à°¸à±à°¤à±‹à°‚à°¦à°¿", "à°’à°•à±‡ à°šà±‹à°Ÿ à°‰à°‚à°Ÿà±‹à°‚à°¦à°¿", "à°Žà°•à±à°•à°¡à°¿à°•à±€ à°µà±à°¯à°¾à°ªà°¿à°‚à°šà°¡à°‚ à°²à±‡à°¦à±"],
      },
      {
        en: "On a scale from 1 (mild) to 10 (most severe), how intense is it right now?",
        q: "1 (à°¸à±à°µà°²à±à°ªà°‚) à°¨à±à°‚à°¡à°¿ 10 (à°¤à±€à°µà±à°°à°‚) à°¸à±à°•à±‡à°²à±â€Œà°ªà±ˆ, à°‡à°ªà±à°ªà±à°¡à± à°ˆ à°¨à±Šà°ªà±à°ªà°¿ à°Žà°‚à°¤ à°¤à±€à°µà±à°°à°‚à°—à°¾ à°‰à°‚à°¦à°¿?",
        cat: "HPI - Severity",
        opts: ["à°¸à±à°µà°²à±à°ªà°‚ (1 - 3)", "à°®à°¿à°¤à°‚ (4 - 6)", "à°¤à±€à°µà±à°°à°®à±ˆà°¨ à°¨à±Šà°ªà±à°ªà°¿ (7 - 8)", "à°…à°¤à±à°¯à°‚à°¤ à°¤à±€à°µà±à°°à°‚ (9 - 10)"],
      },
      {
        en: "Are you experiencing any associated symptoms like sweating, breathlessness, nausea, or dizziness?",
        q: "à°®à±€à°•à± à°šà±†à°®à°Ÿà°²à± à°ªà°Ÿà±à°Ÿà°¡à°‚, à°†à°¯à°¾à°¸à°‚, à°µà°¿à°•à°¾à°°à°‚ à°²à±‡à°¦à°¾ à°•à°³à±à°³à± à°¤à°¿à°°à°—à°¡à°‚ à°²à°¾à°‚à°Ÿà°¿à°µà°¿ à°‰à°¨à±à°¨à°¾à°¯à°¾?",
        cat: "HPI - Associated Symptoms",
        opts: ["à°šà°²à±à°²à°¨à°¿ à°šà±†à°®à°Ÿà°²à± à°ªà°¡à±à°¤à±à°¨à±à°¨à°¾à°¯à°¿", "à°¨à°¡à°¿à°¸à±à°¤à±‡ à°†à°¯à°¾à°¸à°‚ à°µà°¸à±à°¤à±‹à°‚à°¦à°¿", "à°µà°¿à°•à°¾à°°à°‚ à°²à±‡à°¦à°¾ à°µà°¾à°‚à°¤à±à°²à±", "à°¤à°²à°¤à°¿à°°à±à°—à±à°¡à±", "à°‡à°µà±‡à°µà±€ à°²à±‡à°µà±"],
      },
    ],
    Kannada: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à²‡à²‚à²¦à³ à²¨à²¿à²®à³à²® à²ªà³à²°à²®à³à²– à²†à²°à³‹à²—à³à²¯ à²¸à²®à²¸à³à²¯à³† à²…à²¥à²µà²¾ à²¤à³Šà²‚à²¦à²°à³† à²à²¨à³?",
        cat: "Chief Complaint",
        opts: ["à²Žà²¦à³† à²¨à³‹à²µà³ / à²­à²¾à²°", "à²œà³à²µà²° à²®à²¤à³à²¤à³ à²¨à²¡à³à²•", "à²•à³†à²®à³à²®à³ & à²‰à²¸à²¿à²°à²¾à²Ÿà²¦ à²¤à³Šà²‚à²¦à²°à³†", "à²¹à³Šà²Ÿà³à²Ÿà³† à²¨à³‹à²µà³ / à²µà²¾à²•à²°à²¿à²•à³†", "à²•à³€à²²à³ à²…à²¥à²µà²¾ à²¬à³†à²¨à³à²¨à³ à²¨à³‹à²µà³", "à²¸à²¾à²®à²¾à²¨à³à²¯ à²¦à³Œà²°à³à²¬à²²à³à²¯"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à²ˆ à²¤à³Šà²‚à²¦à²°à³† à²¯à²¾à²µà²¾à²— à²¶à³à²°à³à²µà²¾à²¯à²¿à²¤à³ à²®à²¤à³à²¤à³ à²Žà²·à³à²Ÿà³ à²¦à²¿à²¨à²—à²³à²¿à²‚à²¦ à²‡à²¦à³†?",
        cat: "HPI - Onset & Duration",
        opts: ["à²‡à²‚à²¦à³ à²¹à² à²¾à²¤à³à²¤à²¾à²—à²¿ à²¶à³à²°à³à²µà²¾à²¯à²¿à²¤à³", "à²•à²³à³†à²¦ 2-3 à²¦à²¿à²¨à²—à²³à²¿à²‚à²¦", "à²¸à³à²®à²¾à²°à³ 1 à²µà²¾à²°à²¦à²¿à²‚à²¦", "à²’à²‚à²¦à³ à²¤à²¿à²‚à²—à²³à²¿à²—à²¿à²‚à²¤ à²¹à³†à²šà³à²šà³", "à²¬à²‚à²¦à³ à²¹à³‹à²—à³à²¤à³à²¤à²¿à²°à³à²¤à³à²¤à²¦à³†"],
      },
    ],
    Malayalam: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à´‡à´¨àµà´¨àµ à´¨à´¿à´™àµà´™àµ¾à´•àµà´•àµ à´ªàµà´°à´§à´¾à´¨à´®à´¾à´¯àµà´‚ à´Žà´¨àµà´¤à´¾à´£àµ à´†à´°àµ‹à´—àµà´¯ à´ªàµà´°à´¶àµà´¨à´‚?",
        cat: "Chief Complaint",
        opts: ["à´¨àµ†à´žàµà´šàµà´µàµ‡à´¦à´¨ / à´­à´¾à´°à´‚", "à´ªà´¨à´¿à´¯àµà´‚ à´µà´¿à´±à´¯à´²àµà´‚", "à´šàµà´®à´¯àµà´‚ à´¶àµà´µà´¾à´¸à´‚à´®àµà´Ÿàµà´Ÿà´²àµà´‚", "à´µà´¯à´±àµà´µàµ‡à´¦à´¨ / à´›àµ¼à´¦àµà´¦à´¿", "à´¸à´¨àµà´§à´¿à´µàµ‡à´¦à´¨ / à´¨à´Ÿàµà´µàµ‡à´¦à´¨", "à´•àµà´·àµ€à´£à´‚"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à´ˆ à´¬àµà´¦àµà´§à´¿à´®àµà´Ÿàµà´Ÿàµ à´Žà´ªàµà´ªàµ‹à´´à´¾à´£àµ à´¤àµà´Ÿà´™àµà´™à´¿à´¯à´¤àµ?",
        cat: "HPI - Onset & Duration",
        opts: ["à´‡à´¨àµà´¨àµ à´ªàµ†à´Ÿàµà´Ÿàµ†à´¨àµà´¨àµ à´¤àµà´Ÿà´™àµà´™à´¿", "à´•à´´à´¿à´žàµà´ž 2-3 à´¦à´¿à´µà´¸à´®à´¾à´¯à´¿", "à´à´•à´¦àµ‡à´¶à´‚ 1 à´†à´´àµà´šà´¯à´¾à´¯à´¿", "à´’à´°àµ à´®à´¾à´¸à´¤àµà´¤à´¿àµ½ à´•àµ‚à´Ÿàµà´¤à´²à´¾à´¯à´¿", "à´‡à´Ÿà´µà´¿à´Ÿàµà´Ÿàµ à´µà´°àµà´¨àµà´¨àµ"],
      },
    ],
    Bengali: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à¦†à¦œ à¦†à¦ªà¦¨à¦¾à¦° à¦ªà§à¦°à¦§à¦¾à¦¨ à¦¸à§à¦¬à¦¾à¦¸à§à¦¥à§à¦¯ à¦¸à¦®à¦¸à§à¦¯à¦¾ à¦•à§€?",
        cat: "Chief Complaint",
        opts: ["à¦¬à§à¦•à§‡ à¦¬à§à¦¯à¦¥à¦¾ à¦¬à¦¾ à¦šà¦¾à¦ª", "à¦œà§à¦¬à¦° à¦à¦¬à¦‚ à¦•à¦¾à¦à¦ªà§à¦¨à¦¿", "à¦•à¦¾à¦¶à¦¿ à¦“ à¦¶à§à¦¬à¦¾à¦¸à¦•à¦·à§à¦Ÿ", "à¦ªà§‡à¦Ÿ à¦¬à§à¦¯à¦¥à¦¾ à¦¬à¦¾ à¦¬à¦®à¦¿ à¦­à¦¾à¦¬", "à¦—à¦¾à¦à¦Ÿà§‡ à¦¬à¦¾ à¦ªà¦¿à¦ à§‡ à¦¬à§à¦¯à¦¥à¦¾", "à¦¦à§à¦°à§à¦¬à¦²à¦¤à¦¾"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à¦à¦‡ à¦¸à¦®à¦¸à§à¦¯à¦¾à¦Ÿà¦¿ à¦•à¦–à¦¨ à¦¶à§à¦°à§ à¦¹à¦¯à¦¼à§‡à¦›à¦¿à¦² à¦à¦¬à¦‚ à¦•à¦¤à¦¦à¦¿à¦¨ à¦§à¦°à§‡ à¦¹à¦šà§à¦›à§‡?",
        cat: "HPI - Onset & Duration",
        opts: ["à¦†à¦œ à¦¹à¦ à¦¾à§Ž à¦¶à§à¦°à§ à¦¹à¦¯à¦¼à§‡à¦›à§‡", "à¦—à¦¤ à§¨-à§© à¦¦à¦¿à¦¨ à¦§à¦°à§‡", "à¦ªà§à¦°à¦¾à¦¯à¦¼ à§§ à¦¸à¦ªà§à¦¤à¦¾à¦¹ à¦§à¦°à§‡", "à¦à¦• à¦®à¦¾à¦¸à§‡à¦°à¦“ à¦¬à§‡à¦¶à¦¿", "à¦®à¦¾à¦à§‡ à¦®à¦¾à¦à§‡ à¦¹à¦¯à¦¼"],
      },
    ],
    Marathi: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à¤†à¤œ à¤¤à¥à¤®à¥à¤¹à¤¾à¤²à¤¾ à¤¨à¥‡à¤®à¤•à¤¾ à¤•à¤¾à¤¯ à¤¤à¥à¤°à¤¾à¤¸ à¤¹à¥‹à¤¤ à¤†à¤¹à¥‡?",
        cat: "Chief Complaint",
        opts: ["à¤›à¤¾à¤¤à¥€à¤¤ à¤¦à¥à¤–à¤£à¥‡ / à¤œà¤¡à¤ªà¤£à¤¾", "à¤¤à¤¾à¤ª à¤†à¤£à¤¿ à¤¥à¤‚à¤¡à¥€", "à¤–à¥‹à¤•à¤²à¤¾ à¤†à¤£à¤¿ à¤§à¤¾à¤ª à¤²à¤¾à¤—à¤£à¥‡", "à¤ªà¥‹à¤Ÿà¤¦à¥à¤–à¥€ à¤•à¤¿à¤‚à¤µà¤¾ à¤®à¤³à¤®à¤³", "à¤¸à¤¾à¤‚à¤§à¥‡à¤¦à¥à¤–à¥€ à¤•à¤¿à¤‚à¤µà¤¾ à¤ªà¤¾à¤ à¤¦à¥à¤–à¥€", "à¤…à¤¶à¤•à¥à¤¤à¤ªà¤£à¤¾"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à¤¹à¤¾ à¤¤à¥à¤°à¤¾à¤¸ à¤•à¤§à¥€ à¤¸à¥à¤°à¥‚ à¤à¤¾à¤²à¤¾ à¤†à¤£à¤¿ à¤•à¤¿à¤¤à¥€ à¤¦à¤¿à¤µà¤¸à¤¾à¤‚à¤ªà¤¾à¤¸à¥‚à¤¨ à¤¹à¥‹à¤¤à¥‹à¤¯?",
        cat: "HPI - Onset & Duration",
        opts: ["à¤†à¤œ à¤…à¤šà¤¾à¤¨à¤• à¤¸à¥à¤°à¥‚ à¤à¤¾à¤²à¤¾", "à¤—à¥‡à¤²à¥à¤¯à¤¾ à¥¨-à¥© à¤¦à¤¿à¤µà¤¸à¤¾à¤‚à¤ªà¤¾à¤¸à¥‚à¤¨", "à¤¸à¥à¤®à¤¾à¤°à¥‡ à¥§ à¤†à¤ à¤µà¤¡à¥à¤¯à¤¾à¤ªà¤¾à¤¸à¥‚à¤¨", "à¤à¤•à¤¾ à¤®à¤¹à¤¿à¤¨à¥à¤¯à¤¾à¤ªà¥‡à¤•à¥à¤·à¤¾ à¤œà¤¾à¤¸à¥à¤¤", "à¤•à¤®à¥€-à¤œà¤¾à¤¸à¥à¤¤ à¤¹à¥‹à¤¤à¥‹à¤¯"],
      },
    ],
    Gujarati: [
      {
        en: "What is your main health concern or symptom today?",
        q: "àª†àªœà«‡ àª¤àª®àª¨à«‡ àª®à«àª–à«àª¯ àª¶à«àª‚ àª¤àª•àª²à«€àª« àª›à«‡?",
        cat: "Chief Complaint",
        opts: ["àª›àª¾àª¤à«€àª®àª¾àª‚ àª¦à«àª–àª¾àªµà«‹ / àª­àª¾àª°à«‡àªªàª£à«àª‚", "àª¤àª¾àªµ àª…àª¨à«‡ àª§à«àª°à«àªœàª¾àª°à«€", "àª–àª¾àª‚àª¸à«€ àª…àª¨à«‡ àª¶à«àªµàª¾àª¸ àªšàª¡àªµà«‹", "àªªà«‡àªŸàª®àª¾àª‚ àª¦à«àª–àª¾àªµà«‹ / àª‰àª¬àª•àª¾", "àª¸àª¾àª‚àª§àª¾ àª•à«‡ àª•àª®àª°àª¨à«‹ àª¦à«àª–àª¾àªµà«‹", "àª¨àª¬àª³àª¾àªˆ"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "àª† àª¤àª•àª²à«€àª« àª•à«àª¯àª¾àª°à«‡ àª¶àª°à«‚ àª¥àªˆ?",
        cat: "HPI - Onset & Duration",
        opts: ["àª†àªœà«‡ àª…àªšàª¾àª¨àª• àª¶àª°à«‚ àª¥àªˆ", "àª›à«‡àª²à«àª²àª¾ 2-3 àª¦àª¿àªµàª¸àª¥à«€", "àª†àª¶àª°à«‡ 1 àª…àª àªµàª¾àª¡àª¿àª¯àª¾àª¥à«€", "àªàª• àª®àª¹àª¿àª¨àª¾àª¥à«€ àªµàª§à«", "àªµàª¾àª°àª‚àªµàª¾àª° àª¥àª¾àª¯ àª›à«‡"],
      },
    ],
    Punjabi: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à¨…à©±à¨œ à¨¤à©à¨¹à¨¾à¨¨à©‚à©° à¨®à©à©±à¨– à¨¤à©Œà¨° 'à¨¤à©‡ à¨•à©€ à¨¤à¨•à¨²à©€à¨«à¨¼ à¨¹à©ˆ?",
        cat: "Chief Complaint",
        opts: ["à¨›à¨¾à¨¤à©€ à¨µà¨¿à©±à¨š à¨¦à¨°à¨¦ à¨œà¨¾à¨‚ à¨­à¨¾à¨°à¨¾à¨ªà¨¨", "à¨¬à©à¨–à¨¼à¨¾à¨° à¨…à¨¤à©‡ à¨•à©°à¨¬à¨£à©€", "à¨–à©°à¨˜ à¨…à¨¤à©‡ à¨¸à¨¾à¨¹ à¨šà©œà©à¨¹à¨¨à¨¾", "à¨ªà©‡à¨Ÿ à¨¦à¨°à¨¦ à¨œà¨¾à¨‚ à¨‰à¨²à¨Ÿà©€", "à¨œà©‹à©œà¨¾à¨‚ à¨œà¨¾à¨‚ à¨ªà¨¿à©±à¨  à¨¦à¨¾ à¨¦à¨°à¨¦", "à¨•à¨®à¨œà¨¼à©‹à¨°à©€"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à¨‡à¨¹ à¨¤à¨•à¨²à©€à¨«à¨¼ à¨•à¨¦à©‹à¨‚ à¨¸à¨¼à©à¨°à©‚ à¨¹à©‹à¨ˆ à¨¸à©€?",
        cat: "HPI - Onset & Duration",
        opts: ["à¨…à©±à¨œ à¨…à¨šà¨¾à¨¨à¨• à¨¸à¨¼à©à¨°à©‚ à¨¹à©‹à¨ˆ", "à¨ªà¨¿à¨›à¨²à©‡ 2-3 à¨¦à¨¿à¨¨à¨¾à¨‚ à¨¤à©‹à¨‚", "à¨²à¨—à¨­à¨— 1 à¨¹à¨«à¨¼à¨¤à©‡ à¨¤à©‹à¨‚", "à¨‡à©±à¨• à¨®à¨¹à©€à¨¨à©‡ à¨¤à©‹à¨‚ à¨µà©±à¨§", "à¨°à©à¨•-à¨°à©à¨• à¨•à©‡ à¨¹à©à©°à¨¦à©€ à¨¹à©ˆ"],
      },
    ],
    Odia: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à¬†à¬œà¬¿ à¬†à¬ªà¬£à¬™à­à¬•à­ à¬ªà­à¬°à¬§à¬¾à¬¨à¬¤à¬ƒ à¬•â€™à¬£ à¬¸à­à­±à¬¾à¬¸à­à¬¥à­à­Ÿ à¬¸à¬®à¬¸à­à­Ÿà¬¾ à¬¬à¬¾ à¬•à¬·à­à¬Ÿ à¬¹à­‡à¬‰à¬›à¬¿?",
        cat: "Chief Complaint",
        opts: ["à¬›à¬¾à¬¤à¬¿à¬°à­‡ à¬¯à¬¨à­à¬¤à­à¬°à¬£à¬¾ à¬¬à¬¾ à¬­à¬¾à¬°à­€à¬ªà¬£", "à¬¤à­€à¬¬à­à¬° à¬œà­à­±à¬° à¬“ à¬¥à¬£à­à¬¡à¬¾/à¬•à¬®à­à¬ª", "à¬•à¬¾à¬¶ à¬à¬¬à¬‚ à¬¶à­à­±à¬¾à¬¸à¬•à¬·à­à¬Ÿ", "à¬ªà­‡à¬Ÿ à¬¯à¬¨à­à¬¤à­à¬°à¬£à¬¾ à¬¬à¬¾ à¬¬à¬¾à¬¨à­à¬¤à¬¿ à¬­à¬¾à¬¬", "à¬—à¬£à­à¬ à¬¿ à¬¬à¬¾ à¬…à¬£à­à¬Ÿà¬¾ à¬¬à¬¿à¬¨à­à¬§à¬¾", "à¬¦à­à¬°à­à¬¬à¬³à¬¤à¬¾"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à¬à¬¹à¬¿ à¬…à¬¸à­à¬¬à¬¿à¬§à¬¾ à¬•à­‡à¬¬à­‡à¬ à¬¾à¬°à­ à¬†à¬°à¬®à­à¬­ à¬¹à­‹à¬‡à¬›à¬¿ à¬à¬¬à¬‚ à¬•à­‡à¬¤à­‡ à¬¦à¬¿à¬¨ à¬¹à­‡à¬²à¬¾à¬£à¬¿?",
        cat: "HPI - Onset & Duration",
        opts: ["à¬†à¬œà¬¿ à¬¹à¬ à¬¾à¬¤à­ à¬†à¬°à¬®à­à¬­ à¬¹à­‡à¬²à¬¾", "à¬—à¬¤ à­¨-à­© à¬¦à¬¿à¬¨ à¬¹à­‡à¬¬", "à¬ªà­à¬°à¬¾à­Ÿ à­§ à¬¸à¬ªà­à¬¤à¬¾à¬¹à¬°à­", "à¬®à¬¾à¬¸à¬•à¬°à­ à¬…à¬§à¬¿à¬• à¬¸à¬®à­Ÿ à¬¹à­‡à¬²à¬¾à¬£à¬¿", "à¬®à¬à¬¿à¬°à­‡ à¬®à¬à¬¿à¬°à­‡ à¬¹à­‡à¬‰à¬›à¬¿"],
      },
      {
        en: "How would you describe the sensation or character of this issue?",
        q: "à¬à¬¹à¬¿ à¬¯à¬¨à­à¬¤à­à¬°à¬£à¬¾à¬° à¬…à¬¨à­à¬­à­‚à¬¤à¬¿ à¬•à¬¿à¬ªà¬°à¬¿ à¬…à¬›à¬¿?",
        cat: "HPI - Character",
        opts: ["à¬šà¬¾à¬ª à¬¬à¬¾ à¬­à¬¾à¬°à­€à¬ªà¬£ à¬…à¬¨à­à¬­à¬¬", "à¬›à­à¬žà­à¬šà¬¿ à¬«à­‹à¬¡à¬¼à¬¿ à¬¹à­‡à¬¬à¬¾ à¬­à¬³à¬¿ à¬¤à­€à¬¬à­à¬°", "à¬§à­€à¬° à¬¨à¬¿à¬°à¬¨à­à¬¤à¬° à¬¯à¬¨à­à¬¤à­à¬°à¬£à¬¾", "à¬œà¬³à¬¾à¬ªà­‹à¬¡à¬¼à¬¾ à¬…à¬¨à­à¬­à¬¬", "à¬§à¬ªà¬§à¬ª à¬¹à­‡à¬¬à¬¾ à¬¯à¬¨à­à¬¤à­à¬°à¬£à¬¾"],
      },
      {
        en: "Does the discomfort spread or radiate to any other part of your body?",
        q: "à¬¯à¬¨à­à¬¤à­à¬°à¬£à¬¾ à¬¬à¬¾à¬® à¬¹à¬¾à¬¤, à¬¬à­‡à¬• à¬•à¬¿à¬®à­à¬¬à¬¾ à¬ªà¬¿à¬ à¬¿à¬•à­ à¬¬à­à­Ÿà¬¾à¬ªà­à¬›à¬¿ à¬•à¬¿?",
        cat: "HPI - Radiation",
        opts: ["à¬¬à¬¾à¬® à¬¹à¬¾à¬¤ / à¬•à¬¾à¬¨à­à¬§à¬•à­ à¬¬à­à­Ÿà¬¾à¬ªà­à¬›à¬¿", "à¬¬à­‡à¬• à¬¬à¬¾ à¬šà¬¿à¬¬à­à¬•à¬•à­ à¬¯à¬¾à¬‰à¬›à¬¿", "à¬ªà¬¿à¬ à¬¿à¬•à­ à¬¬à­à­Ÿà¬¾à¬ªà­à¬›à¬¿", "à¬—à­‹à¬Ÿà¬¿à¬ à¬œà¬¾à¬—à¬¾à¬°à­‡ à¬°à¬¹à­à¬›à¬¿", "à¬•à­‡à¬‰à¬à¬ à¬¿à¬•à­ à¬¬à­à­Ÿà¬¾à¬ªà­ à¬¨à¬¾à¬¹à¬¿à¬"],
      },
      {
        en: "On a scale from 1 (mild) to 10 (most severe), how intense is it right now?",
        q: "à­§ à¬°à­ à­§à­¦ à¬®à¬§à­à­Ÿà¬°à­‡ à¬à¬¹à¬¿ à¬•à¬·à­à¬Ÿ à¬¬à¬°à­à¬¤à­à¬¤à¬®à¬¾à¬¨ à¬•à­‡à¬¤à­‡ à¬—à­à¬°à­à¬¤à¬°?",
        cat: "HPI - Severity",
        opts: ["à¬¸à¬¾à¬®à¬¾à¬¨à­à­Ÿ (à­§ - à­©)", "à¬®à¬§à­à­Ÿà¬® (à­ª - à­¬)", "à¬—à­à¬°à­à¬¤à¬° (à­­ - à­®)", "à¬…à¬¤à­à­Ÿà¬¨à­à¬¤ à¬¤à­€à¬¬à­à¬° (à­¯ - à­§à­¦)"],
      },
      {
        en: "Are you experiencing any associated symptoms like sweating, breathlessness, nausea, or dizziness?",
        q: "à¬à¬¾à¬³ à¬¬à­‹à¬¹à¬¿à¬¬à¬¾, à¬¶à­à­±à¬¾à¬¸à¬•à¬·à­à¬Ÿ, à¬¬à¬¾à¬¨à­à¬¤à¬¿ à¬¬à¬¾ à¬®à­à¬£à­à¬¡ à¬¬à­à¬²à¬¾à¬‡à¬¬à¬¾ à¬­à¬³à¬¿ à¬²à¬•à­à¬·à¬£ à¬…à¬›à¬¿ à¬•à¬¿?",
        cat: "HPI - Associated Symptoms",
        opts: ["à¬…à¬¤à­à­Ÿà¬§à¬¿à¬• à¬à¬¾à¬³ à¬¬à­‹à¬¹à­à¬›à¬¿", "à¬šà¬¾à¬²à¬¿à¬²à­‡ à¬¶à­à­±à¬¾à¬¸à¬•à¬·à­à¬Ÿ à¬¹à­‡à¬‰à¬›à¬¿", "à¬¬à¬¾à¬¨à­à¬¤à¬¿ à¬¬à¬¾ à¬“à¬•à¬¾à¬³à¬¿", "à¬®à­à¬£à­à¬¡ à¬¬à­à¬²à¬¾à¬‰à¬›à¬¿", "à¬•à¬¿à¬›à¬¿ à¬¨à¬¾à¬¹à¬¿à¬"],
      },
    ],
    Assamese: [
      {
        en: "What is your main health concern or symptom today?",
        q: "à¦†à¦œà¦¿ à¦†à¦ªà§‹à¦¨à¦¾à§° à¦ªà§à§°à¦§à¦¾à¦¨à¦¤à¦ƒ à¦•à¦¿ à¦¸à§à¦¬à¦¾à¦¸à§à¦¥à§à¦¯ à¦¸à¦®à¦¸à§à¦¯à¦¾ à¦¬à¦¾ à¦…à¦¸à§à¦¬à¦¿à¦§à¦¾ à¦¹à§ˆà¦›à§‡?",
        cat: "Chief Complaint",
        opts: ["à¦¬à§à¦•à§à§° à¦¬à¦¿à¦· à¦¬à¦¾ à¦—à¦§à§à§° à¦…à¦¨à§à¦­à§±", "à¦¤à§€à¦¬à§à¦° à¦œà§à¦¬à§° à¦†à§°à§ à¦•à¦à¦ªà¦¨à¦¿", "à¦•à¦¾à¦¹ à¦†à§°à§ à¦‰à¦¶à¦¾à¦¹-à¦¨à¦¿à¦¶à¦¾à¦¹à§° à¦•à¦·à§à¦Ÿ", "à¦ªà§‡à¦Ÿà§° à¦¬à¦¿à¦· à¦¬à¦¾ à¦¬à¦®à¦¿ à¦­à¦¾à§±", "à¦—à¦¾à¦à¦ à¦¿ à¦¬à¦¾ à¦•à¦à¦•à¦¾à¦²à§° à¦¬à¦¿à¦·", "à¦¸à¦¾à¦§à¦¾à§°à¦£ à¦¦à§à§°à§à¦¬à¦²à¦¤à¦¾"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "à¦à¦‡ à¦¸à¦®à¦¸à§à¦¯à¦¾à¦Ÿà§‹ à¦•à§‡à¦¤à¦¿à¦¯à¦¼à¦¾à§° à¦ªà§°à¦¾ à¦†à§°à¦®à§à¦­ à¦¹à§ˆà¦›à¦¿à¦²?",
        cat: "HPI - Onset & Duration",
        opts: ["à¦†à¦œà¦¿ à¦¹à¦ à¦¾à¦¤à§‡ à¦†à§°à¦®à§à¦­ à¦¹'à¦²", "à¦¯à§‹à§±à¦¾ à§¨-à§© à¦¦à¦¿à¦¨à§° à¦ªà§°à¦¾", "à¦ªà§à§°à¦¾à¦¯à¦¼ à§§ à¦¸à¦ªà§à¦¤à¦¾à¦¹à¦®à¦¾à¦¨à§° à¦ªà§°à¦¾", "à¦à¦®à¦¾à¦¹à§°à§‹ à¦¬à§‡à¦›à¦¿ à¦¦à¦¿à¦¨à§° à¦ªà§°à¦¾", "à¦®à¦¾à¦œà§‡ à¦®à¦¾à¦œà§‡ à¦¹à§ˆ à¦¥à¦¾à¦•à§‡"],
      },
      {
        en: "How would you describe the sensation or character of this issue?",
        q: "à¦à¦‡ à¦¬à¦¿à¦·à§° à¦§à§°à¦£ à¦•à§‡à¦¨à§‡à¦•à§à§±à¦¾?",
        cat: "HPI - Character",
        opts: ["à¦¹à§‡à¦à¦šà¦¾ à¦¬à¦¾ à¦—à¦§à§à§° à¦…à¦¨à§à¦­à§±", "à¦¬à§‡à¦œà¦¿à§°à§‡ à¦¬à¦¿à¦¨à§à¦§à¦¾à§° à¦¦à§°à§‡ à¦¤à§€à¦¬à§à¦° à¦¬à¦¿à¦·", "à¦§à§€à§° à¦¨à¦¿à§°à¦¨à§à¦¤à§° à¦¬à¦¿à¦·", "à¦œà§à¦¬à¦²à¦¾-à¦ªà§‹à§°à¦¾ à¦…à¦¨à§à¦­à§±", "à¦§à¦ªà¦§à¦ªà¦¾à¦‡ à¦¥à¦•à¦¾ à¦¬à¦¿à¦·"],
      },
      {
        en: "Does the discomfort spread or radiate to any other part of your body?",
        q: "à¦¬à¦¿à¦· à¦¬à¦¾à¦“à¦ à¦¹à¦¾à¦¤, à¦¡à¦¿à¦™à¦¿ à¦¬à¦¾ à¦ªà¦¿à¦ à¦¿à¦²à§ˆ à¦¬à¦¿à¦¯à¦¼à¦ªà¦¿à¦›à§‡ à¦¨à§‡à¦•à¦¿?",
        cat: "HPI - Radiation",
        opts: ["à¦¬à¦¾à¦“à¦ à¦¹à¦¾à¦¤ / à¦•à¦¾à¦¨à§à¦§à¦²à§ˆ à¦¬à¦¿à¦¯à¦¼à¦ªà¦¿à¦›à§‡", "à¦¡à¦¿à¦™à¦¿ à¦¬à¦¾ à¦¥à§à¦à¦¤à§°à¦¿à¦²à§ˆ à¦—à§ˆà¦›à§‡", "à¦ªà¦¿à¦ à¦¿à¦²à§ˆ à¦¬à¦¿à¦¯à¦¼à¦ªà¦¿à¦›à§‡", "à¦à¦•à§‡à¦Ÿà¦¾ à¦¸à§à¦¥à¦¾à¦¨à¦¤à§‡ à¦†à¦›à§‡", "à¦•'à¦²à§ˆà¦•à§‹ à¦¬à¦¿à¦¯à¦¼à¦ªà¦¾ à¦¨à¦¾à¦‡"],
      },
      {
        en: "On a scale from 1 (mild) to 10 (most severe), how intense is it right now?",
        q: "à§§ à§° à¦ªà§°à¦¾ à§§à§¦ à§° à¦­à¦¿à¦¤à§°à¦¤ à¦à¦‡ à¦¬à¦¿à¦· à¦•à¦¿à¦®à¦¾à¦¨ à¦¤à§€à¦¬à§à¦°?",
        cat: "HPI - Severity",
        opts: ["à¦®à§ƒà¦¦à§ (à§§ - à§©)", "à¦®à¦§à§à¦¯à¦®à§€à¦¯à¦¼à¦¾ (à§ª - à§¬)", "à¦•à¦ à¦¿à¦¨ (à§­ - à§®)", "à¦…à¦¤à¦¿ à¦¤à§€à¦¬à§à¦° (à§¯ - à§§à§¦)"],
      },
      {
        en: "Are you experiencing any associated symptoms like sweating, breathlessness, nausea, or dizziness?",
        q: "à¦˜à¦¾à¦® à¦“à¦²à§‹à§±à¦¾, à¦‰à¦¶à¦¾à¦¹à§° à¦¸à¦®à¦¸à§à¦¯à¦¾, à¦¬à¦®à¦¿ à¦¬à¦¾ à¦®à§‚à§° à¦˜à§‚à§°à§‹à§±à¦¾ à¦¹à§ˆà¦›à§‡ à¦¨à§‡à¦•à¦¿?",
        cat: "HPI - Associated Symptoms",
        opts: ["à¦ªà§à¦°à¦šà§à§° à¦˜à¦¾à¦® à¦“à¦²à¦¾à¦‡à¦›à§‡", "à¦–à§‹à¦œ à¦•à¦¾à¦¢à¦¼à¦¿à¦²à§‡ à¦‰à¦¶à¦¾à¦¹ à¦¬à¦¨à§à¦§ à¦¹à¦¯à¦¼", "à¦¬à¦®à¦¿ à¦­à¦¾à§±", "à¦®à§‚à§° à¦˜à§‚à§°à¦¾à¦‡à¦›à§‡", "à¦à¦•à§‹ à¦¨à¦¾à¦‡"],
      },
    ],
    Urdu: [
      {
        en: "What is your main health concern or symptom today?",
        q: "Ø¢Ø¬ Ø¢Ù¾ Ú©Ùˆ Ø¨Ù†ÛŒØ§Ø¯ÛŒ Ø·ÙˆØ± Ù¾Ø± Ú©ÛŒØ§ ØµØ­Øª Ú©Ø§ Ù…Ø³Ø¦Ù„Û ÛŒØ§ ØªÚ©Ù„ÛŒÙ ÛÛ’ØŸ",
        cat: "Chief Complaint",
        opts: ["Ø³ÛŒÙ†Û’ Ù…ÛŒÚº Ø¯Ø±Ø¯ ÛŒØ§ Ø¨Ú¾Ø§Ø±ÛŒ Ù¾Ù†", "ØªÛŒØ² Ø¨Ø®Ø§Ø± Ø§ÙˆØ± Ú©Ù¾Ú©Ù¾ÛŒ", "Ú©Ú¾Ø§Ù†Ø³ÛŒ Ø§ÙˆØ± Ø³Ø§Ù†Ø³ Ù¾Ú¾ÙˆÙ„Ù†Ø§", "Ù¾ÛŒÙ¹ Ù…ÛŒÚº Ø¯Ø±Ø¯ ÛŒØ§ Ù…ØªÙ„ÛŒ", "Ø¬ÙˆÚ‘ÙˆÚº ÛŒØ§ Ú©Ù…Ø± Ú©Ø§ Ø¯Ø±Ø¯", "Ø´Ø¯ÛŒØ¯ Ú©Ù…Ø²ÙˆØ±ÛŒ"],
      },
      {
        en: "When did this symptom start, and how long has it been happening?",
        q: "ÛŒÛ ØªÚ©Ù„ÛŒÙ Ú©Ø¨ Ø´Ø±ÙˆØ¹ ÛÙˆØ¦ÛŒ Ø§ÙˆØ± Ú©ØªÙ†Û’ Ø¹Ø±ØµÛ’ Ø³Û’ ÛÛ’ØŸ",
        cat: "HPI - Onset & Duration",
        opts: ["Ø¢Ø¬ Ø§Ú†Ø§Ù†Ú© Ø´Ø±ÙˆØ¹ ÛÙˆØ¦ÛŒ", "Ú¯Ø²Ø´ØªÛ Û²-Û³ Ø¯Ù†ÙˆÚº Ø³Û’", "ØªÙ‚Ø±ÛŒØ¨Ø§Ù‹ Û± ÛÙØªÛ’ Ø³Û’", "Ø§ÛŒÚ© Ù…Ø§Û Ø³Û’ Ø²ÛŒØ§Ø¯Û Ø¹Ø±ØµÛ’ Ø³Û’", "ÙˆÙ‚ÙÛ’ ÙˆÙ‚ÙÛ’ Ø³Û’ ÛÙˆØªÛŒ ÛÛ’"],
      },
      {
        en: "How would you describe the sensation or character of this issue?",
        q: "Ø§Ø³ Ø¯Ø±Ø¯ ÛŒØ§ ØªÚ©Ù„ÛŒÙ Ú©ÛŒ Ù†ÙˆØ¹ÛŒØª Ú©ÛŒØ³ÛŒ ÛÛ’ØŸ",
        cat: "HPI - Character",
        opts: ["Ø¯Ø¨Ø§Ø¤ ÛŒØ§ Ø¨Ú¾Ø§Ø±ÛŒ Ù¾Ù†", "Ø³ÙˆØ¦ÛŒ Ú©ÛŒ Ø·Ø±Ø­ Ú†Ø¨Ú¾ØªØ§ ÛÙˆØ§ Ø¯Ø±Ø¯", "ÛÙ„Ú©Ø§ Ù…Ø³Ù„Ø³Ù„ Ø¯Ø±Ø¯", "Ø¬Ù„Ù† Ú©Ø§ Ø§Ø­Ø³Ø§Ø³", "Ø¯Ú¾Ú‘Ú©ØªØ§ ÛÙˆØ§ Ø¯Ø±Ø¯"],
      },
      {
        en: "Does the discomfort spread or radiate to any other part of your body?",
        q: "Ú©ÛŒØ§ ÛŒÛ Ø¯Ø±Ø¯ Ø¨Ø§Ø¦ÛŒÚº Ø¨Ø§Ø²ÙˆØŒ Ú¯Ø±Ø¯Ù† ÛŒØ§ Ú©Ù…Ø± Ú©ÛŒ Ø·Ø±Ù Ù¾Ú¾ÛŒÙ„ØªØ§ ÛÛ’ØŸ",
        cat: "HPI - Radiation",
        opts: ["Ø¨Ø§Ø¦ÛŒÚº Ø¨Ø§Ø²Ùˆ / Ú©Ù†Ø¯Ú¾Û’ Ú©ÛŒ Ø·Ø±Ù Ù¾Ú¾ÛŒÙ„ØªØ§ ÛÛ’", "Ú¯Ø±Ø¯Ù† ÛŒØ§ Ø¬Ø¨Ú‘Û’ Ú©ÛŒ Ø·Ø±Ù Ø¬Ø§ØªØ§ ÛÛ’", "Ú©Ù…Ø± Ú©ÛŒ Ø·Ø±Ù Ù¾Ú¾ÛŒÙ„ØªØ§ ÛÛ’", "Ø§ÛŒÚ© ÛÛŒ Ø¬Ú¯Û Ø±ÛØªØ§ ÛÛ’", "Ú©ÛÛŒÚº Ù†ÛÛŒÚº Ù¾Ú¾ÛŒÙ„ØªØ§"],
      },
      {
        en: "On a scale from 1 (mild) to 10 (most severe), how intense is it right now?",
        q: "Û± Ø³Û’ Û±Û° Ú©Û’ Ù¾ÛŒÙ…Ø§Ù†Û’ Ù¾Ø±ØŒ Ø§Ø¨Ú¾ÛŒ ÛŒÛ Ø¯Ø±Ø¯ Ú©ØªÙ†Ø§ Ø´Ø¯ÛŒØ¯ ÛÛ’ØŸ",
        cat: "HPI - Severity",
        opts: ["ÛÙ„Ú©Ø§ (Û± - Û³)", "Ø¯Ø±Ù…ÛŒØ§Ù†Û (Û´ - Û¶)", "Ø´Ø¯ÛŒØ¯ (Û· - Û¸)", "Ø§Ù†ØªÛØ§Ø¦ÛŒ Ø´Ø¯ÛŒØ¯ (Û¹ - Û±Û°)"],
      },
      {
        en: "Are you experiencing any associated symptoms like sweating, breathlessness, nausea, or dizziness?",
        q: "Ú©ÛŒØ§ Ù¾Ø³ÛŒÙ†Û Ø¢Ù†Ø§ØŒ Ø³Ø§Ù†Ø³ Ù¾Ú¾ÙˆÙ„Ù†Ø§ØŒ Ù…ØªÙ„ÛŒ ÛŒØ§ Ú†Ú©Ø± Ø¢Ù†Û’ Ø¬ÛŒØ³ÛŒ Ø¹Ù„Ø§Ù…Ø§Øª ÛÛŒÚºØŸ",
        cat: "HPI - Associated Symptoms",
        opts: ["Ø¨ÛØª Ø²ÛŒØ§Ø¯Û Ù¾Ø³ÛŒÙ†Û Ø¢ Ø±ÛØ§ ÛÛ’", "Ú†Ù„Ù†Û’ Ù¾Ø± Ø³Ø§Ù†Ø³ Ù¾Ú¾ÙˆÙ„ØªÛŒ ÛÛ’", "Ù…ØªÙ„ÛŒ ÛŒØ§ Ù‚Û’", "Ú†Ú©Ø± Ø¢ Ø±ÛÛ’ ÛÛŒÚº", "Ú©ÙˆØ¦ÛŒ Ø§ÙˆØ± Ø¹Ù„Ø§Ù…Øª Ù†ÛÛŒÚº"],
      },
    ],
  };
  ...
  if (isAyushMode && historyLength >= 4 && historyLength <= 6) {
    return {
      ...
      questionInLanguage:
        language === "Hindi"
          ? "à¤†à¤¯à¥à¤· à¤®à¥‚à¤²à¥à¤¯à¤¾à¤‚à¤•à¤¨: à¤†à¤ªà¤•à¥€ à¤­à¥‚à¤– (à¤…à¤—à¥à¤¨à¤¿), à¤ªà¤¾à¤šà¤¨ à¤”à¤° à¤¶à¤¾à¤°à¥€à¤°à¤¿à¤• à¤ªà¥à¤°à¤•à¥ƒà¤¤à¤¿ (à¤µà¤¾à¤¤/à¤ªà¤¿à¤¤à¥à¤¤/à¤•à¤«) à¤•à¥ˆà¤¸à¥€ à¤°à¤¹à¤¤à¥€ à¤¹à¥ˆ?"
          : language === "Tamil"
          ? "à®†à®¯à¯à®·à¯ à®ªà®°à®¿à®šà¯‹à®¤à®©à¯ˆ: à®‰à®™à¯à®•à®³à¯ à®ªà®šà®¿, à®šà¯†à®°à®¿à®®à®¾à®©à®®à¯ à®®à®±à¯à®±à¯à®®à¯ à®‰à®Ÿà®²à®¿à®©à¯ à®¤à®©à¯à®®à¯ˆ (à®µà®¾à®¤, à®ªà®¿à®¤à¯à®¤, à®•à®ª) à®Žà®ªà¯à®ªà®Ÿà®¿ à®‰à®³à¯à®³à®¤à¯?"
      ...
      touchOptions:
        language === "Hindi"
          ? ["à¤‰à¤¤à¥à¤¤à¤® à¤­à¥‚à¤– à¤”à¤° à¤¸à¤®à¤¯ à¤ªà¤° à¤ªà¤¾à¤šà¤¨", "à¤…à¤¨à¤¿à¤¯à¤®à¤¿à¤¤ à¤­à¥‚à¤– / à¤—à¥ˆà¤¸ à¤¬à¤¨à¤¨à¤¾ (à¤µà¤¾à¤¤)", "à¤¤à¥€à¤µà¥à¤° à¤­à¥‚à¤– à¤”à¤° à¤¸à¥€à¤¨à¥‡ à¤®à¥‡à¤‚ à¤œà¤²à¤¨ (à¤ªà¤¿à¤¤à¥à¤¤)", "à¤®à¤‚à¤¦ à¤­à¥‚à¤– à¤”à¤° à¤­à¤¾à¤°à¥€à¤ªà¤¨ (à¤•à¤«)", "à¤…à¤¨à¥à¤¯"]
...
function generateHeuristicSummary(params: any) {
  ...
  return {
    ...
    aiDisclaimer:
      "AI-generated draft â€” Physician verification required. This summary is intended to assist medical reasoning and counseling and is not an autonomous medical diagnosis.",
  };
}
...
app.post("/api/ai/transcribe", async (req, res) => {
  try {
    ...
    const prompt = `
You are the speech transcription engine for CASE LINE, a multilingual patient history-taking system.

Transcribe the patient's spoken audio accurately.

Primary patient language: ${selectedLanguage}

Requirements:
- Preserve the patient's meaning exactly.
- Support natural code-switching such as Tamil-English, Hinglish, and other Indian-language code-switching.
- Do not diagnose the patient.
- Do not summarize.
- Do not add medical information that was not spoken.
- Preserve clinically important words, numbers, medicines, symptoms, durations, body locations, severity, and negations.
...
`;
    ...
    console.error("CASE LINE Gemini transcription error:", error);
